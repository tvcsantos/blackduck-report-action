...
class ActionOrchestrator {
    inputs;
    blackDuckClient;
    blackDuckEnhancedClient;
    reportGeneratorFactory = report_generator_factory_1.ReportGeneratorFactory.getInstance();
    makeBlackDuckClient() {
        return new black_duck_client_1.BlackDuckClient(this.inputs.blackDuckUrl, this.inputs.blackDuckToken);
    }
    makeBlackDuckEnhancedClient() {
        return new black_duck_enhanced_client_1.BlackDuckEnhancedClient(this.blackDuckClient, this.reportGeneratorFactory);
    }
    ...
    async execute(inputs) {
        ...
        const filePath = await this.blackDuckEnhancedClient.generateReport(this.getProjectProperties(), this.getReportProperties());
...
class BlackDuckClient {
    basePath;
    token;
    static TOKEN_EXPIRATION_DELTA = 5 * 60 * 1000; // 5 minutes
    cachedAuthenticationExpireTime = null;
    cachedAuthentication = null;
    clientInstance;
    rootResourcesDict = null;
    async authenticationHook(config) {
    ...
    constructor(basePath, token) {
        ...
        this.clientInstance.interceptors.request.use(async (config) => this.authenticationHook(config));
    }
    isTokenExpired() {
        return (!this.cachedAuthenticationExpireTime ||
            Date.now() >
    ...
    async getResourceUrlByName(name, parent) {
     ...
     */
    async getResource(name, parent, properties) {
        if (name.length <= 0) {
    ...
    async getJson(url, properties) {
        ...
        if ('content-type' in response.headers) {
            ...
            const values = contentType.split(',').map((x) => x.trim());
            if (values.some((x) => x === 'internal')) {
                core.warning(`Response contains internal proprietary Content-Type: ${contentType}`);
            }
        }
        core.debug(`Response received from '${url}': '${JSON.stringify(response.data)}'`);
    ...
    async getResourceUrlByPath(path, parent) {
        if (!path.startsWith('/')) {
            path = `/${path}`;
        }
...
exports.BlackDuckClient = BlackDuckClient;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.BlackDuckEnhancedClient = void 0;
const utils_1 = __nccwpck_require__(239);
class BlackDuckEnhancedClient {
    blackDuckClient;
    reportGeneratorFactory;
    static ITEMS_DEFAULT_PAGE_SIZE = 50;
    static PROJECTS_RESOURCE = 'projects';
    static VERSIONS_RESOURCE = 'versions';
    static NAME_SEARCH = 'name';
    static VERSION_NAME_SEARCH = 'versionName';
    constructor(blackDuckClient, reportGeneratorFactory) {
    ...
    async getProjectByName(projectName) {
        ...
        return (0, utils_1.asyncIteratorFirstOrUndefined)(projectsWithName, x => x.name === projectName);
    }
    async getProjectVersions(project) {
        return this.blackDuckClient.getItemsByName(BlackDuckEnhancedClient.VERSIONS_RESOURCE, project);
    }
...
exports.BlackDuckEnhancedClient = BlackDuckEnhancedClient;
...
const outputs_1 = __nccwpck_require__(7474);
async function run() {
    const inputs = (0, inputs_1.gatherInputs)();
    const outputs = await new action_orchestrator_1.ActionOrchestrator().execute(inputs);
    (0, outputs_1.setOutputs)(outputs);
}
...
(function (Input) {
    ...
    Input["BLACKDUCK_URL"] = "blackduck-url";
    Input["BLACKDUCK_TOKEN"] = "blackduck-token";
    Input["PROJECT_NAME"] = "project-name";
    Input["PROJECT_VERSION"] = "project-version";
...
// noinspection SpellCheckingInspection
var SbomReportType;
(function (SbomReportType) {
    // noinspection SpellCheckingInspection
    SbomReportType["SPDX_22"] = "SPDX_22";
    SbomReportType["SPDX_23"] = "SPDX_23";
...
(function (SPDXReportFormat) {
    // noinspection SpellCheckingInspection
    SPDXReportFormat["JSON"] = "JSON";
    SPDXReportFormat["YAML"] = "YAML";
    SPDXReportFormat["RDF"] = "RDF";
    SPDXReportFormat["TAGVALUE"] = "TAGVALUE";
})(SPDXReportFormat || (exports.SPDXReportFormat = SPDXReportFormat = {}));
var CycloneDXReportFormat;
...
function getInputBlackDuckUrl() {
    return core.getInput(Input.BLACKDUCK_URL, { required: true });
}
function getInputBlackDuckToken() {
...
function verifyMatchingReportTypeAndFormat(reportType, reportFormat) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.setOutputs = exports.Output = void 0;
const core = __importStar(__nccwpck_require__(2186));
var Output;
(function (Output) {
    Output["REPORT_FILE_PATH"] = "report-file-path";
...
class DefaultReportGenerator {
    ...
    async downloadAndSaveFile(url, outputDirectory, fileName) {
        ...
        const fileStream = fs_1.default.createWriteStream(`${outputDirectory}/${savedFileName}`);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.asyncIteratorSingle = exports.asyncIteratorFirstOrUndefined = exports.asyncIterableIteratorToArray = exports.retrySuccessWithExponentialBackoff = void 0;
const core = __importStar(__nccwpck_require__(2186));
async function retrySuccessWithExponentialBackoff(func, initialDelayMs, maxCumulativeDelayMs, maxRetries, shouldRetry) {
...
exports.retrySuccessWithExponentialBackoff = retrySuccessWithExponentialBackoff;
async function asyncIterableIteratorToArray(iterator) {
    const result = [];
...
exports.asyncIterableIteratorToArray = asyncIterableIteratorToArray;
async function asyncIteratorFirstOrUndefined(iterator, predicate) {
    for await (const element of iterator) {
...
exports.asyncIteratorFirstOrUndefined = asyncIteratorFirstOrUndefined;
async function asyncIteratorSingle(iterator) {
...
exports.asyncIteratorSingle = asyncIteratorSingle;
